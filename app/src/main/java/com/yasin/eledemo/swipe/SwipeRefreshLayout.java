...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final int SCALE_DOWN_DURATION = 1500;
    ...
    private void setColorViewAlpha(int targetAlpha) {
        if(mCircleView.getBackground()!=null){
    ...
    void startScaleDownAnimation(Animation.AnimationListener listener) {
        mScaleDownAnimation = new Animation() {
            @Override
            public void applyTransformation(float interpolatedTime, Transformation t) {
                float offset=-mSpinnerOffsetEnd*interpolatedTime;
                setTargetOffsetTopAndBottom((int)offset,true);
            }
        };
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        mProgress.setProgressRotation(360*rotation);
